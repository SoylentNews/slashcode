...
INSERT INTO vars (name, value, description) VALUES ('approvedtags','b|i|p|br|a|ol|ul|li|dl|dt|dd|em|strong|tt|blockquote|irony|div|ecode|quote','Tags that you can use');
...
INSERT INTO vars (name, value, description) VALUES ('cvs_tag_currentcode','slashcode_14_08','The current cvs tag that the code was updated to - this does not affect site behavior but may be useful for your records');
...
INSERT INTO vars (name, value, description) VALUES ('nesting_maxdepth','1','Maximum depth to which <IRONY>-type tags can be nested');
